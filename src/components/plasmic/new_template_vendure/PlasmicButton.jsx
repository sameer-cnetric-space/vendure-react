...
import sty from "./PlasmicButton.module.css"; // plasmic-import: AHmQZeuRNXKDJT/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: wwF3WJBDN8L3XS/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: R8IV8dCSEryP5m/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__aJjO)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__pieVg)}
                role={"img"}
              />
            ),
